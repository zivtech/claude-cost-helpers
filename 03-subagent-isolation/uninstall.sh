#!/bin/bash
# Subagent Isolation helper — uninstaller
#
...
echo ""
echo "Uninstalling: Subagent Isolation helper"
echo "========================================="
echo ""
...
# 2. Remove slash command and restore backup if it exists
...
echo "Remove the PostToolUse hook entry that points to:"
echo "  \$HOME/.claude/hooks/cost-helpers/subagent-isolation/file-count-monitor.sh"
echo ""
echo "Done."
echo ""
