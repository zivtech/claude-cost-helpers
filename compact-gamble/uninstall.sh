#!/bin/bash
# Compact Gamble helper — uninstaller
#
...
echo ""
echo "Uninstalling: Compact Gamble helper"
echo "====================================="
echo ""
...
echo "Remove the PreCompact hook entry that points to:"
echo "  \$HOME/.claude/hooks/cost-helpers/compact-gamble/pre-compact-backup.sh"
echo ""
echo "Done."
echo ""
