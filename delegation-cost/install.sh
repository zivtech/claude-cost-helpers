...
cp "${SCRIPT_DIR}/delegation_report.py" "${HOOK_DIR}/delegation_report.py"
chmod +x "${HOOK_DIR}/delegation_report.py"
echo "      -> ${HOOK_DIR}/delegation_report.py"
...
echo "  4. Run /delegation-report to see result sizes priced for this session's model and TTL"
echo ""
