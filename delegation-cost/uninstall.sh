#!/bin/bash
# Delegation Cost helper — uninstaller
#
...
echo ""
echo "Uninstalling: Delegation Cost helper"
echo "======================================"
echo ""
...
# 2. Remove slash command and restore backup if one exists
...
echo "  \$HOME/.claude/hooks/cost-helpers/delegation-cost/delegation-result-monitor.sh"
echo ""
echo "Done."
echo ""
