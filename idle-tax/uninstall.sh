#!/bin/bash
# Idle Tax helper — uninstaller
#
# Removes the hook and slash commands. Restores any *.bak.* files left by
...
echo ""
echo "Uninstalling: Idle Tax helper"
echo "=============================="
echo ""
...
echo "  \$HOME/.claude/hooks/cost-helpers/idle-tax/cache-idle-timer.sh"
echo ""
echo "Done."
echo ""
