---
description: Run a command and redirect output to a temp file. Returns the file path, line count, and a preview (first/last 10 lines) — keeps large output out of context.
---
